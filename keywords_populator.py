...
def get_path_to_header(sPath):
    foundHeader = False
    pathToHeader = ''
    print("Search for header files containing a 'CLASS'")
...
# This function confirms that there is a header file in the Arduino Library
# folder.
...
def create_keyword_file(lData):
    ...
    headerFile = get_header_file_name(headerFilePath)
